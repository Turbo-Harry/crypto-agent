...
_SPECS = (
    ...
    FeatureSpec("expected_slippage_bps", "execution",
                "directional 150 USDT book-sweep VWAP impact vs mid",
                "negative", "OKX normalized L2 book", "drop",
                "信号时点逐档模拟实际开仓侧；未知方向取双侧较差值，深度不足缺失", "v2"),
