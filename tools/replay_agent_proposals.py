...
FROZEN_SCHEMA_VERSION = "agent-proposal-schema-v1"
...
def _frozen_v1_protocol():
    ...
    previous = (config.AGENT_PROPOSAL_PROMPT_VERSION,
                ...
                config.AGENT_PROPOSAL_SCHEMA_VERSION)
    ...
    config.AGENT_PROPOSAL_SCHEMA_VERSION = FROZEN_SCHEMA_VERSION
    try:
        yield
    finally:
        (config.AGENT_PROPOSAL_PROMPT_VERSION,
         config.AGENT_PROPOSAL_IMPLEMENTATION_VERSION,
         config.AGENT_PROPOSAL_SCHEMA_VERSION) = previous
