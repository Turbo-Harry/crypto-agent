...
| [prompts/](prompts/) | AI 提示词 | evolution_loop_prompt（进化循环提示词）、factor_mining_goal_prompt（因子挖掘完善，验证门标准）、[入场准确率、Harness v9/v7 与主动提案 v5 目标 Prompt](prompts/2026-08-24_entry_accuracy_harness_v9_goal_prompt.md)（目标/步骤/样本门/验收/停止门） |
...
| 08-24 | [prompts/2026-08-24_entry_accuracy_harness_v9_goal_prompt.md](prompts/2026-08-24_entry_accuracy_harness_v9_goal_prompt.md) | 入场准确率、Harness v9/v7 与主动提案 v5 的权威目标、步骤、验收和停止规则 |
