...
| [reports/](reports/) | 研究报告与收敛报告 | [15m/4h OKX SWAP 历史重放裁决](reports/2026-08-23_15m_research_replay_report.md)、[历史入场预训练执行报告](reports/2026-08-25_historical_entry_pretraining.md)、[入场模型全拒绝根因审计](reports/2026-08-25_entry_model_reject_root_cause.md)、research_report_round2/3、optimization_report、convergence_report、final_report、evolution_loop_report、optimization_notes（实施日志）、backtest_report、**pitfalls（踩坑档案，写代码前必读）** |
...
| 08-25 | [reports/2026-08-25_entry_model_reject_root_cause.md](reports/2026-08-25_entry_model_reject_root_cause.md) | 12 个模型全拒绝的数据、训练、指标、策略、盘口与消息面深层根因审计 |
| 08-25 | [ops/2026-08-25_chrome_news_capture.md](ops/2026-08-25_chrome_news_capture.md) | 用户主动启用的 OKX Chrome 页面可见内容实时采集与本机研究落库 |
